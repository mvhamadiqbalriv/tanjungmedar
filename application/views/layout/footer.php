...
<div class="footer-grids">
	...
	<div class="col-md-3 footer-grid contact-grid">
			...
			<ul>
				...
				<li><span class="glyphicon glyphicon-envelope" aria-hidden="true"></span><a href="mailto:Kectanjungmedar@gmail.com" target="_blank">Kectanjungmedar@gmail.com</a></li>
			</ul>
	</div>
...
<div class="container">
<div class="copy-left">
	<p>Copyright © 2015 <?php echo $site['namaweb']?>.rights reserved | Design by <a href="<?php echo $site['website']?>"><?php echo $site['namaweb']?></a></p>
</div>
<div class="social-iconst">
	<ul>
		<li><a href="https://web.facebook.com/kecamatan.tanjungmedar.16?_rdc=1&_rdr" target="_blank" class="fb">
			fb
		</a>
		</li>
		<li>
			
		  <a href="https://www.instagram.com/kecamatan_tanjungmedar/" target="_blank" class="ig" >
			fb
       	 </a>
		</li>	
