...
// Form
echo form_open('admin/kategori_produk');
?>
<h2>Tambah Kategori Produk</h2>
<div class="form-group">
<label>Nama kategori</label>
<input type="text" name="nama_kategori_produk" placeholder="Nama kategori produk" value="<?php echo set_value('nama_kategori_produk') ?>" required class="form-control">
</div>
